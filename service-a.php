				...
				<ul class="nav navbar-nav">
					...
					<li role="presentation" class="dropdown active">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li class="active"><a href="service-a.php">Acupuncture</a></li>
							<li class="divider"></li>
		...
		<div class="row text-center">
			<div class="col-sm-3 col-sm-offset-1">
				<ul class="service-items col-sm-left">
					<li><a href="#what-is-massage">What is acupuncture?</a></li>
					<li><a href="#afraid-of-needle">I&rsquo;m afraid of needle.</a></li>
					<li><a href="#electro-acu">Electro Acupuncture</a></li>
					<li><a href="#cupping">Cupping</a></li>
					<li><a href="#moxibustion">Moxibustion</a></li>
					<li><a href="#herb-inquiring">Herb Inquiring</a></li>
				<ul>
			</div>
			<div class="col-sm-7 col-sm-left col-sm-border">
				...
				<h3 id="afraid-of-needle">I&rsquo;m afraid of needle.</h3>
				<article>
					<p>Phobia: needle is 1/100 thinner than ur hair.</p>
					<br />
				</article>
				<h3 id="electro-acu">Electro Acupuncture</h3>
				<article>
					<p>&ldquo;Electro Acupuncture&rdquo; is... </p>
					<br />
				</article>
				<h3 id="cupping">Cupping</h3>
				<article>
					<p>&ldquo;Cupping&rdquo; is... </p>
					<br />
				</article>
				<h3 id="moxibustion">Moxibustion</h3>
				<article>
					<p>&ldquo;Moxibustion&rdquo; is... </p>
					<br />
				</article>
				<h3 id="herb-inquiring">Herb Inquiring</h3>
				<article>
					<p>&ldquo;Herb Inquiring&rdquo; is... </p>
					<br />
				</article>
			</div>
		</div>
